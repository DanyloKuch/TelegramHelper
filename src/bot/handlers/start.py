...
WELCOME = (
    ...
    "/report — звіт трекера по днях (з урахуванням активних запусків)\n"
    "/tasks — завдання, згруповані за проєктами\n"
    "/checkin — заповнити щоденний чек-ін (Google Sheets), поза розкладом\n\n"
    "<b>Меню</b>\n"
